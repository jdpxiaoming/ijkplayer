...
FF_CMAKE_CFG_FLAGS="-DCMAKE_TOOLCHAIN_FILE=$ANDROID_NDK/build/cmake/android.toolchain.cmake -DANDROID_NDK=$ANDROID_NDK -DANDROID_PLATFORM=android-21 -DBUILD_EXAMPLES=0 -DBUILD_LSR_TESTS=0 -DBUILD_SHARED_LIBS=0 -DBUILD_TESTS=0 -DCMAKE_BUILD_TYPE=Release -DWITH_LSR_BINDINGS=0 -DWITH_OPENMP=0 -DWITH_PFFFT=0 -DHAVE_WORDS_BIGENDIAN_EXITCODE=1 -DHAVE_WORDS_BIGENDIAN_EXITCODE__TRYRUN_OUTPUT="
